...
-- Default sizes for different devices
local defaultWindowSize = isMobile and UDim2.new(0, 400, 0, 500) or UDim2.new(0, 530, 0, 400)
local defaultTabButtonSize = isMobile and UDim2.new(1, 0, 0, 40) or UDim2.new(1, 0, 0, 30)

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "Nytrix"
...
do
	...
	function background(pl, t, d, i, ty)
		...
		RealBackground.Size = UDim2.new(1, 0,0, isMobile and 45 or 35)
		...
		TextLabel_2.Size = UDim2.new(1, 0,0, isMobile and 16 or 14)
		TextLabel_2.Font = Enum.Font.GothamBold
		TextLabel_2.RichText = true
		TextLabel_2.Text = tostring(t)
		TextLabel_2.TextColor3 = Color3.fromRGB(255,255,255)
		TextLabel_2.TextSize = isMobile and 14 or 12
		...
		if i and i ~= "" then
			UIPadding_3.PaddingLeft = UDim.new(0, isMobile and 60 or 50)
			...
			Image.Size = UDim2.new(0, isMobile and 50 or 40,1, 0)
			...
			Icon_1.Size = UDim2.new(0, isMobile and 25 or 20,0, isMobile and 25 or 20)
		...
		local function updateSize()
			task.defer(function()
				local newSize = UIListLayout_2.AbsoluteContentSize.Y + (isMobile and 25 or 21)
	...
	function addDropdownSelect(p, p2, Multi, Callback, Value, List)
		...
		F.Size = UDim2.new(0, isMobile and 140 or 120,0.800000012, 0)
		...
		DropdownValue.Size = UDim2.new(0, isMobile and 120 or 100,0, isMobile and 25 or 20)
		...
		TextLabelValue_1.TextSize = isMobile and 12 or 10
		...
		ImageLabel_1.Size = UDim2.new(0, isMobile and 25 or 20,0, isMobile and 25 or 20)
		...
		DropdownSelect.Size = UDim2.new(0, isMobile and 170 or 150,0, 0)
		DropdownSelect.ClipsDescendants = true

		addToTheme('Function.Dropdown.Dropdown Select.Background', DropdownSelect)

		DropdownSelect.Position = UDim2.new(0, DropdownValue.AbsolutePosition.X - DropdownSelect.Parent.AbsolutePosition.X + DropdownValue.Size.X.Offset - (isMobile and 139 : 119), 0, DropdownValue.AbsolutePosition.Y - DropdownSelect.Parent.AbsolutePosition.Y + DropdownValue.Size.Y.Offset - (isMobile and 30 : 25))
		...
		Search_1.Size = UDim2.new(1, 0,0, isMobile and 25 : 20)
		...
		TextBox_1.TextSize = isMobile and 13 : 11
		...
		UIPadding_4.PaddingTop = UDim.new(0,isMobile and 30 : 25)
		...
		local function updateDropdownSize()
			...
			local contentHeight = (UIListLayout_1.AbsoluteContentSize.Y + (isMobile and 64 : 54))
			if contentHeight > 200 then
				contentHeight = 200
			end

			tw({v = DropdownSelect, t = 0.15, s = Enum.EasingStyle.Exponential, d = "Out", g = {Size = UDim2.new(0, isMobile and 170 or 150, 0, contentHeight)}}):Play()
		end
		...
		local function open()
			...
			local targetX = DropdownValue.AbsolutePosition.X - DropdownSelect.Parent.AbsolutePosition.X + DropdownValue.Size.X.Offset - (isMobile and 139 : 119)
			local targetY = DropdownValue.AbsolutePosition.Y - DropdownSelect.Parent.AbsolutePosition.Y + DropdownValue.Size.Y.Offset - (isMobile and 30 : 25)
			local contentHeight = UIListLayout_1.AbsoluteContentSize.Y + (isMobile and 64 : 54)
			if contentHeight <= 200 then
				tw({v = DropdownSelect, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {Size = UDim2.new(0, isMobile and 170 or 150, 0, contentHeight), Position = UDim2.new(0, targetX, 0, targetY)}}):Play()
			else
				tw({v = DropdownSelect, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {Size = UDim2.new(0, isMobile and 170 or 150, 0, 200), Position = UDim2.new(0, targetX, 0, targetY)}}):Play()
			end
		...
		local function close()
			...
			local gf = tw({v = DropdownSelect, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {Size = UDim2.new(0, isMobile and 170 or 150,0, 0)}})
			gf:Play()
		...
		function itemslist:Add(text)
			...
			Item_1.Size = UDim2.new(1, 0,0, isMobile and 22 : 18)
			...
			TextLabel_1.TextColor3 = Color3.fromRGB(255,255,255)
			TextLabel_1.TextSize = isMobile and 14 : 12
			TextLabel_1.TextXAlignment = Enum.TextXAlignment.Left
...
function Nytrix:Window(p)
	...
	UIPadding_2.PaddingLeft = UDim.new(0,isMobile and 140 : 120)
	UIPadding_2.PaddingRight = UDim.new(0,5)
	UIPadding_2.PaddingTop = UDim.new(0,isMobile and 55 : 45)
	...
	Topbar_1.Size = UDim2.new(1, 0,0, isMobile and 52 : 42)
	...
	Minisize_1.Size = UDim2.new(0, isMobile and 20 : 16,0, isMobile and 20 : 16)
	...
	Close_1.Size = UDim2.new(0, isMobile and 20 : 16,0, isMobile and 20 : 16)
	...
	ChSize_1.Size = UDim2.new(0, isMobile and 20 : 16,0, isMobile and 20 : 16)
	...
	DropdownValue_1.Size = UDim2.new(0, isMobile and 140 : 120,0, isMobile and 25 : 20)
	...
	Icon_1.BorderColor3 = Color3.fromRGB(0,0,0)
	Icon_1.BorderSizePixel = 0
	Icon_1.Size = UDim2.new(0, isMobile and 40 : 30,0, isMobile and 40 : 30)
	...
	Desc_1.Size = UDim2.new(1, 0,0, isMobile and 15 : 13)
	Desc_1.Font = Enum.Font.GothamBold
	Desc_1.Text = Desc
	Desc_1.TextColor3 = Color3.fromRGB(255,255,255)
	Desc_1.TextSize = isMobile and 12 : 10
	...
	Title_2.Size = UDim2.new(1, 0,0, isMobile and 15 : 13)
	Title_2.Font = Enum.Font.GothamBold
	Title_2.Text = Title
	Title_2.TextColor3 = Color3.fromRGB(255,255,255)
	Title_2.TextSize = isMobile and 14 : 12
	...
	Frame_6.Size = UDim2.new(0, isMobile and 130 : 110,1, 0)
	...
	Select_1.Size = UDim2.new(0, 3,0, isMobile and 22 : 18)
	...
	UIPadding_17.PaddingTop = UDim.new(0,isMobile and 55 : 45)
	...
	function Tabs:Tab(p)
		...
		Tab_1.Size = defaultTabButtonSize
		...
		Title_3.TextSize = isMobile and 13 : 11
		...
		ImageLabel_2.Size = UDim2.new(0, isMobile and 22 : 18,0, isMobile and 22 : 18)
		...
		function Func:Section(p)
			...
			RealBackground.BorderColor3 = Color3.fromRGB(0,0,0)
			RealBackground.BorderSizePixel = 0
			RealBackground.Size = UDim2.new(1, 0,0, isMobile and 25 : 20)
			RealBackground.ClipsDescendants = true
			...
			Section.Size = UDim2.new(1, 0,0, isMobile and 25 : 20)
		...
		function Func:Toggle(p)
			...
			F_1.Size = UDim2.new(0, isMobile and 120 : 100,0.800000012, 0)
			...
			Frame_1.BorderColor3 = Color3.fromRGB(0,0,0)
			Frame_1.BorderSizePixel = 0
			Frame_1.Size = UDim2.new(0, isMobile and 44 : 34,0, isMobile and 22 : 17)
			...
			Frame_2.Size = UDim2.new(0, isMobile and 18 : 13,0, isMobile and 18 : 13)
		...
		function Func:Button(p)
			...
			Config:SetTextTransparencyTitle(0)
			Config:SetSizeT(isMobile and 60 : 50)
			...
			F.BorderSizePixel = 0
			F.Position = UDim2.new(1, 0,0.5, 0)
			F.Size = UDim2.new(0, isMobile and 60 : 50,0.800000012, 0)
			...
			Image_1.Size = UDim2.new(0, isMobile and 25 : 20,0, isMobile and 25 : 20)
		...
		function Func:Slider(p)
			...
			Config:SetTextTransparencyTitle(0)
			Config:SetSizeT(isMobile and 220 : 200)
			...
			F.BorderSizePixel = 0
			F.Position = UDim2.new(1, 0,0.5, 0)
			F.Size = UDim2.new(0, isMobile and 215 : 195,0.8, 0)
			...
			FrameValueTextBox.Size = UDim2.new(0, isMobile and 60 : 50,0, isMobile and 25 : 20)
			...
			TextBox_1.TextColor3 = Color3.fromRGB(255,255,255)
			TextBox_1.TextSize = isMobile and 14 : 12
			...
			Frame_1.BorderColor3 = Color3.fromRGB(0,0,0)
			Frame_1.BorderSizePixel = 0
			Frame_1.Size = UDim2.new(0, isMobile and 140 : 120,0, isMobile and 25 : 20)
			...
			Frame_2.Size = UDim2.new(1, 0,0, isMobile and 12 : 10)
			...
			Frame_4.Size = UDim2.new(0, isMobile and 16 : 13,0, isMobile and 16 : 13)
		...
		function Func:Code(p)
			...
			RealBackground.BorderColor3 = Color3.fromRGB(0,0,0)
			RealBackground.BorderSizePixel = 0
			RealBackground.Size = UDim2.new(1, 0,0, isMobile and 140 : 120)
			RealBackground.ClipsDescendants = true
			...
			UIPadding_2.Parent = Frame_1
			UIPadding_2.PaddingTop = UDim.new(0,isMobile and 35 : 30)
			...
			TextBox_2.TextSize = isMobile and 14 : 12
			...
			Top_1.Size = UDim2.new(1, 0,0, isMobile and 35 : 30)
			...
			Whatisthis_1.Size = UDim2.new(0, 50,0, isMobile and 15 : 13)
			...
			Frame_3.BorderColor3 = Color3.fromRGB(0,0,0)
			Frame_3.BorderSizePixel = 0
			Frame_3.Size = UDim2.new(0, 100,0, isMobile and 35 : 30)
			...
			Frame_4.Size = UDim2.new(1, 0,0, isMobile and 35 : 30)
			...
			TextLabel_1.BorderColor3 = Color3.fromRGB(0,0,0)
			TextLabel_1.BorderSizePixel = 0
			TextLabel_1.Size = UDim2.new(1, 0,0, isMobile and 30 : 25)
			TextLabel_1.Font = Enum.Font.GothamBold
			TextLabel_1.Text = tostring(Title)
			TextLabel_1.TextColor3 = Color3.fromRGB(255,255,255)
			TextLabel_1.TextSize = isMobile and 13 : 11
			...
			Frame_5.BorderColor3 = Color3.fromRGB(0,0,0)
			Frame_5.BorderSizePixel = 0
			Frame_5.Size = UDim2.new(0, isMobile and 70 : 60,0, isMobile and 35 : 30)
			...
			TextButton_1.TextSize = isMobile and 13 : 11
			...
			ImageLabel_1.Size = UDim2.new(0, isMobile and 20 : 16,0, isMobile and 20 : 16)
			...
			LineText_1.TextSize = isMobile and 14 : 12
			...
			TextButton_1.MouseButton1Click:Connect(function()
				if not iscop then
					...
					Frame_5.Size = UDim2.new(0, isMobile and 75 : 65,0, isMobile and 35 : 30)
					iscop = true
					delay(1, function()
						TextButton_1.Text = "Copy"
						ImageLabel_1.Image = "rbxassetid://13847222481"
						Frame_5.Size = UDim2.new(0, isMobile and 68 : 58,0, isMobile and 35 : 30)
						iscop = false
					end)
				end
			end)
			...
			local function updateLineNumbers()
				tw({v = RealBackground, t = 0.15, s = Enum.EasingStyle.Exponential, d = "Out", g = {Size = UDim2.new(1, 0,0, TextBox_2.TextBounds.Y + (isMobile and 75 : 65))}}):Play()
				tw({v = Frame_3, t = 0.15, s = Enum.EasingStyle.Exponential, d = "Out", g = {Size = UDim2.new(0, TextLabel_1.TextBounds.X + (isMobile and 40 : 30),0, isMobile and 35 : 30)}}):Play()
		...
		function Func:Dropdown(p)
			...
			Config:SetTextTransparencyTitle(0)
			Config:SetSizeT(isMobile and 145 : 125)
		...
		function Func:Keybind(p)
			...
			Config:SetSizeT(isMobile and 120 : 100)
			...
			F.BorderSizePixel = 0
			F.Position = UDim2.new(1, 0,0.5, 0)
			F.Size = UDim2.new(0, isMobile and 120 : 100,0.800000012, 0)
			F.Text = ''
			...
			ToggleValue_1.Size = UDim2.new(0, isMobile and 44 : 34,0, isMobile and 22 : 17)
			...
			Frame_1.BorderSizePixel = 0
			Frame_1.Position = UDim2.new(1, 0,0.5, 0)
			Frame_1.Size = UDim2.new(0, isMobile and 18 : 13,0, isMobile and 18 : 13)
			...
			KeybindValue_1.Size = UDim2.new(0, isMobile and 40 : 30,0, isMobile and 25 : 20)
			...
			TextLabel_1.TextColor3 = Color3.fromRGB(255,255,255)
			TextLabel_1.TextSize = isMobile and 12 : 10
			...
			local function adjustBoxBindSize()
				...
				tw({v = KeybindValue_1, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {Size = UDim2.new(0, textSize.X + (isMobile and 25 : 20), 0, isMobile and 25 : 20)}}):Play()
			end
		...
		function Func:ColorPicker(p)
			...
			Picker_1.Size = UDim2.new(0, isMobile and 25 : 20,0, isMobile and 25 : 20)
			...
			Picker_2.Size = UDim2.new(0, isMobile and 16 : 12,0, isMobile and 16 : 12)
			...
			ColorpickBar.Size = UDim2.new(0, isMobile and 140 : 120,0, 0)
			ColorpickBar.ClipsDescendants = true
			local targetX = Picker_1.AbsolutePosition.X - ColorpickBar.Parent.AbsolutePosition.X + Picker_1.Size.X.Offset - (isMobile and 120 : 100)
			local targetY = Picker_1.AbsolutePosition.Y - ColorpickBar.Parent.AbsolutePosition.Y + Picker_1.Size.Y.Offset - (isMobile and 25 : 20)
			...
			Color_1.Position = UDim2.new(0, 0,0, isMobile and 30 : 25)
			Color_1.Size = UDim2.new(0, isMobile and 100 : 80,0, isMobile and 100 : 80)
			Color_1.ZIndex = 10
			...
			ColorSelection_1.Size = UDim2.new(0, isMobile and 16 : 12,0, isMobile and 16 : 12)
			...
			Hue_1.Position = UDim2.new(0.47, 0,0, isMobile and 30 : 25)
			Hue_1.Size = UDim2.new(0, isMobile and 12 : 10,0, isMobile and 100 : 80)
			...
			HueSelection_1.Size = UDim2.new(0, isMobile and 16 : 12,0, isMobile and 16 : 12)
			...
			BoxColor.Position = UDim2.new(1, 0,0, isMobile and 30 : 25)
			BoxColor.Size = UDim2.new(0, isMobile and 100 : 80,0, isMobile and 100 : 80)
			...
			Hax_1.Size = UDim2.new(1, 0,0, isMobile and 25 : 21)
			...
			BarValueHax_1.Size = UDim2.new(0.6, 0,0, isMobile and 18 : 15)
			...
			TextLabel_1.TextSize = isMobile and 11 : 9
			...
			TextLabel_2.Size = UDim2.new(0, isMobile and 25 : 20,0, isMobile and 25 : 20)
			TextLabel_2.Font = Enum.Font.Gotham
			TextLabel_2.Text = "Hax"
			TextLabel_2.TextSize = isMobile and 11 : 9
			TextLabel_2.TextXAlignment = Enum.TextXAlignment.Left
			TextLabel_2.TextColor3 = Color3.fromRGB(255, 255, 255)
			...
			Red_1.LayoutOrder = 1
			Red_1.Size = UDim2.new(1, 0,0, isMobile and 25 : 21)
			...
			BarValueRed_1.Size = UDim2.new(0.600000024, 0,0, isMobile and 18 : 15)
			...
			TextLabel_3.TextSize = isMobile and 11 : 9
			...
			TextLabel_4.Size = UDim2.new(0, isMobile and 25 : 20,0, isMobile and 25 : 20)
			TextLabel_4.Font = Enum.Font.Gotham
			TextLabel_4.Text = "Red"
			TextLabel_4.TextSize = isMobile and 11 : 9
			...
			Green_1.Size = UDim2.new(1, 0,0, isMobile and 25 : 21)
			...
			BarValueGreen_1.Size = UDim2.new(0.600000024, 0,0, isMobile and 18 : 15)
			...
			TextLabel_5.TextSize = isMobile and 11 : 9
			...
			TextLabel_6.Size = UDim2.new(0, isMobile and 25 : 20,0, isMobile and 25 : 20)
			TextLabel_6.Font = Enum.Font.Gotham
			TextLabel_6.Text = "Green"
			TextLabel_6.TextSize = isMobile and 11 : 9
			...
			Blue_1.Size = UDim2.new(1, 0,0, isMobile and 25 : 21)
			...
			BarValueBlue_1.Size = UDim2.new(0.600000024, 0,0, isMobile and 18 : 15)
			...
			TextLabel_7.TextSize = isMobile and 11 : 9
			...
			TextLabel_8.Size = UDim2.new(0, isMobile and 25 : 20,0, isMobile and 25 : 20)
			TextLabel_8.Font = Enum.Font.Gotham
			TextLabel_8.Text = "Blue"
			TextLabel_8.TextSize = isMobile and 11 : 9
			...
			Shower.Size = UDim2.new(0, isMobile and 50 : 40, 0, isMobile and 20 : 15)
			...
			local function open()
				local targetX = Picker_1.AbsolutePosition.X - ColorpickBar.Parent.AbsolutePosition.X + Picker_1.Size.X.Offset - (isMobile and 165 : 145)
				local targetY = Picker_1.AbsolutePosition.Y - ColorpickBar.Parent.AbsolutePosition.Y + Picker_1.Size.Y.Offset - (isMobile and 60 : 50)
				tw({v = ColorpickBar, t = 0.15, s = Enum.EasingStyle.Exponential, d = "Out", g = {Size = UDim2.new(0, isMobile and 220 : 200,0, isMobile and 145 : 125), Position = UDim2.new(0, targetX, 0, targetY)}}):Play()
				tw({v = UIStroke_1, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {Transparency = 0.95}}):Play()
			end
			local function close()
				isopen = false
				tw({v = ColorpickBar, t = 0.15, s = Enum.EasingStyle.Exponential, d = "Out", g = {Size = UDim2.new(0, isMobile and 220 : 200,0, 0)}}):Play()
		...
		function Func:Textbox(p)
			...
			Config:SetTextTransparencyTitle(0)
			Config:SetSizeT(isMobile and 165 : 145)
			...
			F.BorderSizePixel = 0
			F.Position = UDim2.new(1, 0,0.5, 0)
			F.Size = UDim2.new(0, isMobile and 170 : 150,0.800000012, 0)
			...
			Frame_1.BorderColor3 = Color3.fromRGB(0,0,0)
			Frame_1.BorderSizePixel = 0
			Frame_1.Size = UDim2.new(0, isMobile and 150 : 130,0, isMobile and 30 : 25)
			...
			ImageLabel_1.BorderSizePixel = 0
			ImageLabel_1.Position = UDim2.new(1, 0,0.5, 0)
			ImageLabel_1.Size = UDim2.new(0, isMobile and 20 : 15,0, isMobile and 20 : 15)
		...
		function Func:Image()
			...
			ImageLogo.Size = UDim2.new(1,0,isMobile and 200 : 180,0)
	...
	function Tabs:Notify(p)
		...
		Shadow.Size = UDim2.new(0, isMobile and 200 : 180,0, 0)
		...
		Title_1.TextSize = isMobile and 14 : 12
		...
		Description_1.TextSize = isMobile and 12 : 10
		...
		local function updateSize()
			task.defer(function()
				local newSize = UIListLayout_1.AbsoluteContentSize.Y + (isMobile and 32 : 28)
				if Shadow.Size.Y.Offset ~= newSize then
					Shadow.Size = UDim2.new(0, isMobile and 200 : 180, 0, newSize)
				end
			end)
		end
		...
		local g = tw({
			...
			d = "InOut",
			g = {
				Size = UDim2.new(0, isMobile and 200 : 180,0, isMobile and 65 : 55)
			}
		})
		g:Play()
		g.Completed:Wait()
		...
		task.spawn(function()
			...
			f.Completed:Connect(function()
				...
				local g = tw({
					...
					d = "InOut",
					g = {
						Size = UDim2.new(0, isMobile and 200 : 180,0, 0)
					}
				})
				g:Play()
	...
	function Tabs:Dialog(p)
		...
		TextLabel_1.BorderColor3 = Color3.fromRGB(0,0,0)
		TextLabel_1.BorderSizePixel = 0
		TextLabel_1.Size = UDim2.new(0, 200,0, isMobile and 35 : 30)
		TextLabel_1.Font = Enum.Font.GothamBold
		TextLabel_1.RichText = true
		TextLabel_1.Text = tostring(Title)
		TextLabel_1.TextColor3 = Color3.fromRGB(255,255,255)
		TextLabel_1.TextSize = isMobile and 22 : 20
		...
		Frame_2.BorderSizePixel = 0
		Frame_2.LayoutOrder = 1
		Frame_2.Size = UDim2.new(0, 100,0, isMobile and 60 : 50)
		...
		Button1_1.Size = UDim2.new(0, isMobile and 150 : 130,0, isMobile and 50 : 40)
		...
		TextLabel_2.TextSize = isMobile and 18 : 16
		...
		Button2_1.Size = UDim2.new(0, isMobile and 150 : 130,0, isMobile and 50 : 40)
		...
		TextLabel_3.TextSize = isMobile and 18 : 16
		...
		Click1.MouseButton1Click:Connect(function()
			...
			delay(.06, function()
				tw({v = TextLabel_2, t = 0.15, s = Enum.EasingStyle.Back, d = "Out", g = {TextSize = isMobile and 18 : 16}}):Play()
			end)
		...
		Click2.MouseButton1Click:Connect(function()
			...
			delay(.06, function()
				tw({v = TextLabel_3, t = 0.15, s = Enum.EasingStyle.Back, d = "Out", g = {TextSize = isMobile and 18 : 16}}):Play()
			end)
			local f = tw({v = Dialog, t = 0.25, s = Enum.EasingStyle.Linear, d = "Out", g = {GroupTransparency = 1}})
			f:Play()
			f.Completed:Wait()
	...
	do
		...
		Size_1.Size = UDim2.new(0, isMobile and 25 : 20,0, isMobile and 25 : 20)
		...
		U.InputChanged:Connect(function(i)
			if not isZ and R and (i.UserInputType == Enum.UserInputType.MouseMovement or i.UserInputType == Enum.UserInputType.Touch) then
				local nW = math.max(isMobile and 350 : 450, i.Position.X - Shadow_1.AbsolutePosition.X)
				local nH = math.max(isMobile and 250 : 220, i.Position.Y - Shadow_1.AbsolutePosition.Y)
		...
		do
			...
			CloseUIShadow.Size = UDim2.new(0, isMobile and 90 : 70,0, isMobile and 50 : 40)
			...
			CloseUIShadow.Size = UDim2.new(0, Title_1.TextBounds.X + (isMobile and 50 : 40),0, isMobile and 50 : 40)
			...
			Click.MouseButton1Click:Connect(function()
				...
				delay(.06, function()
					tw({v = Title_1, t = 0.15, s = Enum.EasingStyle.Back, d = "Out", g = {TextSize = isMobile and 14 : 12}}):Play()
				end)
				pcall(closeui)
			end)
		end
